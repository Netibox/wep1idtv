...
function workpoint() {
  document.getElementById("objek").innerHTML = '<iframe src="intent://www.livedoomovies.com/02_WORKPOINT_720p/chunklist.m3u8#Intent;package=com.wiseplay;S.referer=https://www.inwiptv.com/&userAgent=exo_player;S.title=TVonline;scheme=https;type=video/mp4;end" height="0" width="0" style="border:none;" title="TV online"></iframe>'
};
function pptv() {
...
function onehd() {
  document.getElementById("objek").innerHTML = '<iframe src="intent://www.livedoomovies.com/02_GMMONE_720p/chunklist.m3u8#Intent;package=com.wiseplay;S.referer=https://bcovlive-a.akamaihd.net/&userAgent=exo_player;S.title=TVonline;scheme=https;type=video/mp4;end" height="0" width="0" style="border:none;" title="TV online"></iframe>'
};
