...
function mono() {
  document.getElementById("objek").innerHTML = '<iframe src="intent://dookeela2.live/live-tv/mono29#Intent;package=com.wiseplay;S.referer=https://dookeela2.live/&userAgent=exo_player;S.title=TVonline;scheme=https;type=video/mp4;end" height="0" width="0" style="border:none;" title="MOVIETV"></iframe>'
};
function channel8() {
