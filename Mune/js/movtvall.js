...
function hbohit2() {
  document.getElementById("objek").innerHTML = '<iframe src="intent://raw.githubusercontent.com/Netibox/MOV69/refs/heads/main/mov/hbohits1.m3u8#Intent;package=com.wiseplay;S.referer=https://github.com/&userAgent=exo_player;S.title=TVonline;scheme=https;type=video/mp4;end" height="0" width="0" style="border:none;" title="MOVIETV"></iframe>'
};
function signaturehbo() {
  document.getElementById("objek").innerHTML = '<iframe src="intent://raw.githubusercontent.com/Netibox/MOV69/refs/heads/main/mov/hbosignature.m3u8#Intent;package=com.wiseplay;S.referer=https://github.com/&userAgent=exo_player;S.title=TVonline;scheme=https;type=video/mp4;end" height="0" width="0" style="border:none;" title="MOVIETV"></iframe>'
};
function truethaifilm() {
  document.getElementById("objek").innerHTML = '<iframe src="intent://raw.githubusercontent.com/Netibox/MOV69/refs/heads/main/mov/truefilm1-1.m3u8#Intent;package=com.wiseplay;S.referer=https://github.com/&userAgent=exo_player;S.title=TVonline;scheme=https;type=video/mp4;end" height="0" width="0" style="border:none;" title="MOVIETV"></iframe>'
};
function truefilmasia() {
  document.getElementById("objek").innerHTML = '<iframe src="intent://raw.githubusercontent.com/Netibox/MOV69/refs/heads/main/mov/truefilmasia1.m3u8#Intent;package=com.wiseplay;S.referer=https://github.com/&userAgent=exo_player;S.title=TVonline;scheme=https;type=video/mp4;end" height="0" width="0" style="border:none;" title="MOVIETV"></iframe>'
};
function truefilm2() {
  document.getElementById("objek").innerHTML = '<iframe src="intent://raw.githubusercontent.com/Netibox/MOV69/refs/heads/main/mov/truefilm2-1.m3u8#Intent;package=com.wiseplay;S.referer=https://github.com/&userAgent=exo_player;S.title=TVonline;scheme=https;type=video/mp4;end" height="0" width="0" style="border:none;" title="MOVIETV"></iframe>'
};
function trueSeries() {
  document.getElementById("objek").innerHTML = '<iframe src="intent://raw.githubusercontent.com/Netibox/MOV69/refs/heads/main/mov/trueseries1.m3u8#Intent;package=com.wiseplay;S.referer=https://github.com/&userAgent=exo_player;S.title=TVonline;scheme=https;type=video/mp4;end" height="0" width="0" style="border:none;" title="MOVIETV"></iframe>'
};
function moviehits() {
...
function mono() {
  document.getElementById("objek").innerHTML = '<iframe src="intent://monomax-uiripn.cdn.byteark.com/plain/th/playlist.m3u8#Intent;package=com.wiseplay;S.referer=https://monomax-uiripn.cdn.byteark.com/&userAgent=exo_player;S.title=TVonline;scheme=https;type=video/mp4;end" height="0" width="0" style="border:none;" title="MOVIETV"></iframe>'
};
function channel8() {
  document.getElementById("objek").innerHTML = '<iframe src="intent://prsmedia-mykojh.cdn.byteark.com/fleetstream/live/720p/index.m3u8#Intent;package=com.wiseplay;S.referer=https://prsmedia-mykojh.cdn.byteark.com/&userAgent=exo_player;S.title=TVonline;scheme=https;type=video/mp4;end" height="0" width="0" style="border:none;" title="MOVIETV"></iframe>'
};
function warnertv() {
