...
function epl1two() {
  document.getElementById("objek").innerHTML = '<iframe src="intent://www.xn--72czaud0ezbn4b8de.com/live/player/epl1#Intent;package=com.wiseplay;S.referer=https://www.xn--72czaud0ezbn4b8de.com/live/&userAgent=exo_player;S.title=PremierHD1;scheme=https;type=video/mp4;end" height="0" width="0" style="border:none;" title="TV online"></iframe>'
};
function epl2() {
...
function epl2two() {
  document.getElementById("objek").innerHTML = '<iframe src="intent://www.xn--72czaud0ezbn4b8de.com/live/player/epl2#Intent;package=com.wiseplay;S.referer=https://www.xn--72czaud0ezbn4b8de.com/live/&userAgent=exo_player;S.title=NETBOX TV;scheme=https;type=video/mp4;end" height="0" width="0" style="border:none;" title="TV online"></iframe>'
};
function beinone() {
