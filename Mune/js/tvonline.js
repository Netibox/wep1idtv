...
function tv5hd() {
  document.getElementById("objek").innerHTML = '<iframe src="intent://639bc5877c5fe.streamlock.net/tv5hdlive/tv5hdlive/playlist.m3u8#Intent;scheme=https;type=video/*;package=com.wiseplay;S.browser_fallback_url=market://details?id=com.wiseplay.ad;S.title=TVNETBOX;end" height="0" width="0" style="border:none;" title="TV online"></iframe>'
};
function tvhd7() {
...
function mono() {
  document.getElementById("objek").innerHTML = '<iframe src="intent://monomax-uiripn.cdn.byteark.com/plain/th/playlist.m3u8#Intent;package=com.wiseplay;S.referer=https://www.adintrend.tv/&userAgent=exo_player;S.title=TVonline;scheme=https;type=video/mp4;end" height="0" width="0" style="border:none;" title="TV online"></iframe>'
};
function workpoint() {
  document.getElementById("objek").innerHTML = '<iframe src="intent://www.livedoomovies.com:4431/02_WORKPOINT_720p/playlist.m3u8#Intent;package=com.wiseplay;S.referer=https://www.movie2k.io/&userAgent=exo_player;S.title=TVonline;scheme=https;type=video/mp4;end" height="0" width="0" style="border:none;" title="TV online"></iframe>'
};
function pptv() {
  document.getElementById("objek").innerHTML = '<iframe src="intent://www.livedoomovies.com:4431/02_PPTVHD_720p/playlist.m3u8#Intent;package=com.wiseplay;S.referer=https://www.movie2k.io/&userAgent=exo_player;S.title=TVonline;scheme=https;type=video/mp4;end" height="0" width="0" style="border:none;" title="TV online"></iframe>'
};
function onehdtv() {
  document.getElementById("objek").innerHTML = '<iframe src="intent://www.livedoomovies.com:4431/02_GMMONE_720p/playlist.m3u8#Intent;package=com.wiseplay;S.referer=https://www.movie2k.io/&userAgent=exo_player;S.title=TVonline;scheme=https;type=video/mp4;end" height="0" width="0" style="border:none;" title="TV online"></iframe>'
};
function pbs() {
...
function mcot() {
  document.getElementById("objek").innerHTML = '<iframe src="intent://www.livedoomovies.com:4431/02_MCOTHD_720p/playlist.m3u8#Intent;package=com.wiseplay;S.referer=https://www.movie2k.io/&userAgent=exo_player;S.title=TVonline;scheme=https;type=video/mp4;end" height="0" width="0" style="border:none;" title="TV online"></iframe>'
};
function cabeltv() {
...
function cnnnew() {
  document.getElementById("objek").innerHTML = '<iframe src="intent://d2e1asnsl7br7b.cloudfront.net/7782e205e72f43aeb4a48ec97f66ebbe/index_5.m3u8#Intent;package=com.wiseplay;S.referer=https://dookeela.live/&userAgent=exo_player;S.title=TVonline;scheme=https;type=video/mp4;end" height="0" width="0" style="border:none;" title="MOVIETV"></iframe>'
};
function bbcnew() {
...
function cnbc() {
  document.getElementById("objek").innerHTML = '<iframe src="intent://fl2.moveonjoy.com/CNBC/index.m3u8#Intent;package=com.wiseplay;S.referer=https://dookeela.live/&userAgent=exo_player;S.title=TVonline;scheme=https;type=video/mp4;end" height="0" width="0" style="border:none;" title="MOVIETV"></iframe>'
};
